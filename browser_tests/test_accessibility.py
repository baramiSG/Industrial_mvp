...
def test_keyboard_tab_order_reaches_every_interactive_control_with_visible_focus(
    ...
    expected = (
        ...
        *(f"open:{case.id}" for case in CASES),
        "selection:pharma_api:substitution",
        "selection:pharma_api:identity",
        "selection:pharma_api:viability",
        "selection:pharma_api:series-gap",
        "selection:pharma_api:frozen",
        "selection:fertilizers:substitution",
        "selection:fertilizers:identity",
        "selection:fertilizers:viability",
        "selection:fertilizers:series-gap",
        "selection:fertilizers:frozen",
        "selection:inputs",
        "id:opportunity-select",
        f"claim:decision.{'simulated' if mode == 'simulated' else 'public'}",
        "claim:metric.trade",
