...
Candidate 6 (implementer-composer, plan-6): DD-25/DD-26 shallow-stable frozen-tree pins in `tests/test_frozen_public_evidence_pins.py`; CI-F-01 repair (P5-F01); no product byte changes under data, config, core, authority, browser, src, scripts, `.github` or Makefile.
